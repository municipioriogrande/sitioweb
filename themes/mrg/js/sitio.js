jQuery(document).ready(function() {
	...
	jQuery("body.page-1er-congreso-internacional-educacion-e-inclusion-desde-el-sur .videos-thumbnails-list video").css("display","none");
	jQuery("body.page-1er-congreso-internacional-educacion-e-inclusion-desde-el-sur-conferencias-y-ponencias .videos-thumbnails-list iframe").css("display","none");
