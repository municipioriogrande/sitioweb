...
<?php
	...
	{
?>
	h1, h2, h3, h4, h5, h6, h7, #imageFlow .title, #contact_form label, .post_header .post_detail, .recent_post_detail, .post_detail, .thumb_content span, .page_caption_desc, .post_date, .post_quote_title, .post_attribute, .comment_date, #post_more_wrapper h5, blockquote, #commentform label, label, #social_share_wrapper, .social_share_wrapper, .social_follow, .fancybox-title-outside-wrap strong, #searchform label { font-family: '<?php echo urldecode($pp_header_font); ?>'; }		
...
<?php
	...
	{
?>
.post_header .post_detail, .recent_post_detail, .post_detail, .thumb_content span, .page_caption_desc, .imageFlow_gallery_info_author, .post_attribute, #crumbs, .comment_date { font-family:'<?php echo urldecode($pp_post_meta_font); ?>' !important; }
<?php
	}
?>
...
<?php
	...
	{
?>
.post_header .post_detail, .recent_post_detail, .post_detail, .thumb_content span, .page_caption_desc, .imageFlow_gallery_info_author, #crumbs { font-size:<?php echo $pp_post_meta_font_size; ?>px; }
<?php
	}
?>
...
<?php
	...
	{
?>
.post_header .post_detail, .recent_post_detail, .post_detail, .thumb_content span, .page_caption_desc, .post_attribute, .comment_date, .imageFlow_gallery_info_author, #crumbs, .comment_date { text-transform: none; }		
<?php
	}
?>
...
<?php
	...
	{
?>
.post_header .post_detail, .recent_post_detail, .post_detail, .thumb_content span, .page_caption_desc, .post_attribute, .comment_date, .imageFlow_gallery_info_author, #crumbs, .comment_date, #page_caption.hasbg #crumbs, #page_caption #crumbs { font-style: normal; }		
<?php
	}
?>
...
<?php
	...
	{
?>
.post_header .post_detail, .recent_post_detail, .post_detail, .thumb_content span, .page_caption_desc, .post_attribute, .comment_date, .imageFlow_gallery_info_author, #crumbs, .comment_date { letter-spacing:<?php echo $pp_post_meta_font_spacing; ?>px; }
<?php
	}
?>
...
<?php
	...
	{
?>
.post_header .post_detail, .recent_post_detail, .post_detail, .thumb_content span, .page_caption_desc, .imageFlow_gallery_info_author, #crumbs, .comment_date { font-weight:<?php echo $pp_post_meta_font_weight; ?>; }
<?php
	}
?>
...
<?php
	...
	if(!empty($pp_menu_border_color) && $pp_menu_border_color != '#ff0000')
	{
...
?>
input[type=text], input[type=password], input[type=email], input[type=tel], .top_bar #searchform input
{
...
<?php
	...
	if(!empty($pp_footer_first_bg_color))
	{
		echo '.footer .row-1 { background-color: '.$pp_footer_first_bg_color.'; }'."\r";
	}
	
	$pp_footer_first_header_color = get_option('pp_footer_first_header_color');
	
	if(!empty($pp_footer_first_header_color))
	{
		echo '.footer .row-1 h4 { color: '.$pp_footer_first_header_color.'; }'."\r";
	}
	
	$pp_footer_first_font_color = get_option('pp_footer_first_font_color');
	
	if(!empty($pp_footer_first_font_color))
	{
		echo '.footer .row-1 li { color: '.$pp_footer_first_font_color.'; }'."\r";
	}
	
	$pp_footer_first_link_color = get_option('pp_footer_first_link_color');
	
	if(!empty($pp_footer_first_link_color))
	{
		echo '.footer .row-1 li a { color: '.$pp_footer_first_link_color.'; }'."\r";
	}
	
	$pp_footer_first_hover_link_color = get_option('pp_footer_first_hover_link_color');
	
	if(!empty($pp_footer_first_hover_link_color))
	{
		echo '.footer .row-1 li a:hover { color: '.$pp_footer_first_hover_link_color.'; }'."\r";
	}
	# Second Row
	$pp_footer_second_bg_color = get_option('pp_footer_second_bg_color');
	
	if(!empty($pp_footer_second_bg_color))
	{
		echo '.footer .row-2 { background-color: '.$pp_footer_second_bg_color.'; }'."\r";
	}
	
	$pp_footer_second_header_color = get_option('pp_footer_second_header_color');
	
	if(!empty($pp_footer_second_header_color))
	{
		echo '.footer .row-2 h4 { color: '.$pp_footer_second_header_color.'; }'."\r";
	}
	
	$pp_footer_second_font_color = get_option('pp_footer_second_font_color');
	
	if(!empty($pp_footer_second_font_color))
	{
		echo '.footer .row-2 li { color: '.$pp_footer_second_font_color.'; }'."\r";
	}
	
	$pp_footer_second_link_color = get_option('pp_footer_second_link_color');
	
	if(!empty($pp_footer_second_link_color))
	{
		echo '.footer .row-2 li a { color: '.$pp_footer_second_link_color.'; }'."\r";
	}
	
	$pp_footer_second_hover_link_color = get_option('pp_footer_second_hover_link_color');
	
	if(!empty($pp_footer_second_hover_link_color))
	{
		echo '.footer .row-2 li a:hover { color: '.$pp_footer_second_hover_link_color.'; }'."\r";
	}
	# Third Row
	$pp_footer_third_bg_color = get_option('pp_footer_third_bg_color');
	
	if(!empty($pp_footer_third_bg_color))
	{
		echo '.footer .row-3 { background-color: '.$pp_footer_third_bg_color.'; }'."\r";
	}
	
	$pp_footer_third_header_color = get_option('pp_footer_third_header_color');
	
	if(!empty($pp_footer_third_header_color))
	{
		echo '.footer .row-3 h4 { color: '.$pp_footer_third_header_color.'; }'."\r";
		echo '.footer .row-3 .col { color: '.$pp_footer_third_header_color.'; }'."\r";
	}
	
	$pp_footer_third_font_color = get_option('pp_footer_third_font_color');
	
	if(!empty($pp_footer_third_font_color))
	{
		echo '.footer .row-3 li { color: '.$pp_footer_third_font_color.'; }'."\r";
	}
	
	$pp_footer_third_link_color = get_option('pp_footer_third_link_color');
	
	if(!empty($pp_footer_third_link_color))
	{
		echo '.footer .row-3 li a { color: '.$pp_footer_third_link_color.'; }'."\r";
	}
	
	$pp_footer_third_hover_link_color = get_option('pp_footer_third_hover_link_color');
	
	if(!empty($pp_footer_third_hover_link_color))
	{
		echo '.footer .row-3 li a:hover { color: '.$pp_footer_third_hover_link_color.'; }'."\r";
	}
	# Fourth Row
	$pp_footer_fourth_bg_color = get_option('pp_footer_fourth_bg_color');
	
	if(!empty($pp_footer_fourth_bg_color))
	{
		echo '.footer .row-4 { background-color: '.$pp_footer_fourth_bg_color.'; }'."\r";
	}
	
	$pp_footer_fourth_header_color = get_option('pp_footer_fourth_header_color');
	
	if(!empty($pp_footer_fourth_header_color))
	{
		echo '.footer .row-4 h4 { color: '.$pp_footer_fourth_header_color.'; }'."\r";
	}
	
	$pp_footer_fourth_font_color = get_option('pp_footer_fourth_font_color');
	
	if(!empty($pp_footer_fourth_font_color))
	{
		echo '.footer .row-4 li { color: '.$pp_footer_fourth_font_color.'; }'."\r";
	}
	
	$pp_footer_fourth_link_color = get_option('pp_footer_fourth_link_color');
	
	if(!empty($pp_footer_fourth_link_color))
	{
		echo '.footer .row-4 li a { color: '.$pp_footer_fourth_link_color.'; }'."\r";
	}
	
	$pp_footer_fourth_hover_link_color = get_option('pp_footer_fourth_hover_link_color');
	
	if(!empty($pp_footer_fourth_hover_link_color))
	{
		echo '.footer .row-4 li a:hover { color: '.$pp_footer_fourth_hover_link_color.'; }'."\r";
	}
?>
