...
?>
<!-- Begin content -->
<!--<div id="page_content_wrapper" <?php if(!empty($pp_page_bg)) { ?>class="fix_height hasbg <?php echo $page_content_wrapper_class ?><?php if(!empty($pp_page_bg) && !empty($global_pp_topbar)) { ?> withtopbar<?php } ?>"<?php } else { ?>class="<?php echo $page_content_wrapper_class ?>"<?php } ?>>-->
<div id="page_content_wrapper" class="fix_height hasbg notransparent">