...
//Get contact form ID
$contact_form_id = 'habitacion_detail_search_form';
...
jQuery(document).ready(function() {
	...
	jQuery('#<?php echo $response_id; ?>').hide();
	jQuery('#<?php echo $contact_form_id; ?>').submit(function() {
        ...
        jQuery('.required_fields').each(function() {
			if(jQuery.trim(jQuery(this).val()) == '') {
                ...
                jQuery('#<?php echo $response_id; ?>').show();
				jQuery('#<?php echo $response_id; ?> ul').append('<li class="error"><?php echo _e( 'Por favor ingrese ', THEMEDOMAIN ); ?> '+labelText+'</li>');
				hasError = true;
			} 
		});
