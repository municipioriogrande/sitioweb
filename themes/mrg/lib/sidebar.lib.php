...
function tg_register_sidebars() {
	...
	**/
	...
	if ( function_exists('register_sidebar') )
	    register_sidebar(array('id' => 'sidebar-12', 'name' => 'Footer Sidebar 2', 'description' => 'The default sidebar for footer2 area of every pages'));
	
	if ( function_exists('register_sidebar') )
	    register_sidebar(array('id' => 'sidebar-13', 'name' => 'Footer Sidebar 3', 'description' => 'The default sidebar for footer3 area of every pages'));
