...
array( "name" => "<h2>Google Maps Setting</h2>API Key",
	"desc" => "Enter Google Maps API Key <a href=\"https://developers.google.com/maps/web/\" target=\"_blank\">How to get API Key</a>",
	"id" => SHORTNAME."_googlemap_api_key",
	"type" => "text",
	"std" => ""
),

array( "name" => "<h2>Hubspot Settings</h2>API Key",
	"desc" => "Enter HubSpot API Key <a href=\"https://developers.hubspot.com/docs/overview\" target=\"_blank\">HubSpot API Overview</a> | <a href=\"https://knowledge.hubspot.com/articles/kcs_article/integrations/how-do-i-get-my-hubspot-api-key\" target=\"_blank\">How do I get my HubSpot API key?</a>",
	"id" => SHORTNAME."_hubspot_api_key",
	"type" => "text",
	"std" => ""
),
...
array( "name" => "Meta Description",
	"desc" => "This is the text for the meta description in general. If a section does not have a meta description, it will be applied.",
...
array( "name" => "Display Hamburguesa Menu",
	"desc" => "Check this to hidden normal menu and display hamburguesa menu",
	"id" => SHORTNAME."_hamburguesa_menu",
	"type" => "iphone_checkboxes",
	"std" => 1
),
...
array( "name" => "<h2>Display mayor name</h2>Display name of Mayor",
	"desc" => "Check this to show name of mayor",
	"id" => SHORTNAME."_mayor_show",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Name of Mayor",
    "desc" => "Enter the name of actual Mayor",
    "id" => SHORTNAME."_mayor_name",
    "type" => "text",
    "std" => ""
),
array( "name" => "URL of Mayor",
    "desc" => "Enter the URL for Mayor name",
    "id" => SHORTNAME."_mayor_url",
    "type" => "text",
    "std" => ""
),


array( "name" => "<h2>Display Wather</h2>Display the wather",
	"desc" => "Check this to show wather",
	"id" => SHORTNAME."_wather_show",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Wather Short Code",
    "desc" => "Enter the short Code for Wather",
    "id" => SHORTNAME."_wather_shortcode",
    "type" => "text",
    "std" => ""
),
...
/* THISNEW { */
array( "name" => "<h2>CTA Button Settings</h2>Display CTA Button in header",
	"desc" => "Select to display CTA button in header next to the search",
	"id" => SHORTNAME."_cta_button_in_header",
	"type" => "iphone_checkboxes",
	"std" => 1
),

array( "name" => "CTA Button Text",
    "desc" => "Enter text to display in CTA button",
    "id" => SHORTNAME."_cta_button_text",
    "type" => "text",
    "std" => ""
),
array( "name" => "CTA Button URL",
    "desc" => "Enter the URL to be used, when you press the button",
    "id" => SHORTNAME."_cta_button_url",
    "type" => "text",
    "std" => ""
),
/* } THISNEW */
...
array( "name" => "<h2>Footer Widgets Area Settings</h2>",
	"type" => "header",
),
...
array( "name" => "Footer Sidebar Rows styles",
	"desc" => "Select the style for Footer",
	"id" => SHORTNAME."_footer_row_style",
	"type" => "radio",
	"options" => array(
		'1' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/1row.gif"/></div>',
		'2' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/2rows.gif"/></div>',
		'3' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/3rows.gif"/></div>',
		'4' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/4rows.gif"/></div>',
	),
),
...
/* First Row { */
array( "name" => "<h2>• First ROW, Columns Settings</h2>",
	"type" => "header",
),
array( "name" => "Footer Sidebar Colum styles",
	"desc" => "Select the style for Footer Sidebar",
	"id" => SHORTNAME."_footer_first_colum_style",
	"type" => "radio",
	"options" => array(
...
array( "name" => "• Columna Uno",
	"desc" => "Ingresar el texto a mostrar en Columna Uno",
	"id" => SHORTNAME."_footer_first_row_column_one",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Dos",
	"desc" => "Ingresar el texto a mostrar en Columna Dos",
	"id" => SHORTNAME."_footer_first_row_column_two",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Tres",
	"desc" => "Ingresar el texto a mostrar en Columna Tres",
	"id" => SHORTNAME."_footer_first_row_column_three",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Cuatro",
	"desc" => "Ingresar el texto a mostrar en Columna Cuatro",
	"id" => SHORTNAME."_footer_first_row_column_four",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Display Short Code",
	"desc" => "Check this to display Short Code",
	"id" => SHORTNAME."_footer_first_show_short_code",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Incluir Short Code en columna (para formularios y otros)",
	"desc" => "Selecciones la columna donde será incluido el Short Code (para formularios y otros)",
	"id" => SHORTNAME."_footer_first_into_colum_code",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Short Code (para formularios y otros)",
	"desc" => "Ingresar el código",
	"id" => SHORTNAME."_footer_first_short_code",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Display social icons",
	"desc" => "Check this to display social icons in footer",
	"id" => SHORTNAME."_footer_first_social_display",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Incluir Iconos de redes sociales",
	"desc" => "Selecciones la columna donde serán incluidos los iconos",
	"id" => SHORTNAME."_footer_first_into_colum_social",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Open Footer Social Icons link in new window",
	...
	"id" => SHORTNAME."_footer_first_social_link_blank",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar linea horizontal separadora",
	"desc" => "Para separar las secciones del footer con una linea divisora",
	"id" => SHORTNAME."_footer_first_separating_horizontal_line",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar idiomas",
	"desc" => "Seleccionar para mostrar idiomas",
	"id" => SHORTNAME."_footer_first_show_languages",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar idiomas en columna",
	"desc" => "Selecciones la columna donde serán incluidos los idiomas",
	"id" => SHORTNAME."_footer_first_column_show_languages",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Mostrar logo",
	"desc" => "Seleccionar para mostrar el logo",
	"id" => SHORTNAME."_footer_first_show_logo",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar logo en columna",
	"desc" => "Selecciones la columna donde serán incluidos el logo",
	"id" => SHORTNAME."_footer_first_column_show_logo",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Background Color",
	"desc" => "Select background color for this area",
	"id" => SHORTNAME."_footer_first_bg_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#000000"
),
...
array( "name" => "Header Font Color",
	"desc" => "Select color for the widget header font",
	"id" => SHORTNAME."_footer_first_header_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),
...
array( "name" => "Font Color",
	"desc" => "Select color for the font",
	"id" => SHORTNAME."_footer_first_font_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#999999"
),
...
array( "name" => "Link Color",
	...
	"id" => SHORTNAME."_footer_first_link_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#aaaaaa"
),
...
array( "name" => "Hover Link Color",
	"desc" => "Select color for the hover font",
	"id" => SHORTNAME."_footer_first_hover_link_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),
...
/* Second Row { */
array( "name" => "<h2>• Second ROW, Columns Settings</h2>",
	"type" => "header",
),
array( "name" => "Footer Sidebar Colum styles",
	"desc" => "Select the style for Footer Sidebar",
	"id" => SHORTNAME."_footer_second_colum_style",
	"type" => "radio",
	"options" => array(
		'1' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/1column.png"/></div>',
		'2' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/2columns.png"/></div>',
...
array( "name" => "• Columna Uno",
	"desc" => "Ingresar el texto a mostrar en Columna Uno",
	"id" => SHORTNAME."_footer_second_row_column_one",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Dos",
	"desc" => "Ingresar el texto a mostrar en Columna Dos",
	"id" => SHORTNAME."_footer_second_row_column_two",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Tres",
	"desc" => "Ingresar el texto a mostrar en Columna Tres",
	"id" => SHORTNAME."_footer_second_row_column_three",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Cuatro",
	"desc" => "Ingresar el texto a mostrar en Columna Cuatro",
	"id" => SHORTNAME."_footer_second_row_column_four",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Display Short Code",
	"desc" => "Check this to display Short Code",
	"id" => SHORTNAME."_footer_second_show_short_code",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Incluir Short Code en columna (para formularios y otros)",
	"desc" => "Selecciones la columna donde será incluido el Short Code (para formularios y otros)",
	"id" => SHORTNAME."_footer_second_into_colum_code",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Short Code (para formularios y otros)",
	"desc" => "Ingresar el código",
	"id" => SHORTNAME."_footer_second_short_code",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Display social icons",
	"desc" => "Check this to display social icons in footer",
	"id" => SHORTNAME."_footer_second_social_display",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Incluir Iconos de redes sociales",
	"desc" => "Selecciones la columna donde serán incluidos los iconos",
	"id" => SHORTNAME."_footer_second_into_colum_social",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Open Footer Social Icons link in new window",
	"desc" => "Check this to open footer social icons link in new window",
	"id" => SHORTNAME."_footer_second_social_link_blank",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar linea horizontal separadora",
	"desc" => "Para separar las secciones del footer con una linea divisora",
	"id" => SHORTNAME."_footer_second_separating_horizontal_line",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar idiomas",
	"desc" => "Seleccionar para mostrar idiomas",
	"id" => SHORTNAME."_footer_second_show_languages",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar idiomas en columna",
	"desc" => "Selecciones la columna donde serán incluidos los idiomas",
	"id" => SHORTNAME."_footer_second_column_show_languages",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Mostrar logo",
	"desc" => "Seleccionar para mostrar el logo",
	"id" => SHORTNAME."_footer_second_show_logo",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar logo en columna",
	"desc" => "Selecciones la columna donde serán incluidos el logo",
	"id" => SHORTNAME."_footer_second_column_show_logo",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Background Color",
	"desc" => "Select background color for this area",
	"id" => SHORTNAME."_footer_second_bg_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#000000"
),
...
array( "name" => "Header Font Color",
	"desc" => "Select color for the widget header font",
	"id" => SHORTNAME."_footer_second_header_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),
...
array( "name" => "Font Color",
	"desc" => "Select color for the font",
	"id" => SHORTNAME."_footer_second_font_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#999999"
),
...
array( "name" => "Link Color",
	"desc" => "Select color for the link",
	"id" => SHORTNAME."_footer_second_link_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#aaaaaa"
),
...
array( "name" => "Hover Link Color",
	"desc" => "Select color for the hover font",
	"id" => SHORTNAME."_footer_second_hover_link_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),
...
/* Third Row { */
array( "name" => "<h2>• Third ROW, Columns Settings</h2>",
	"type" => "header",
),
array( "name" => "Footer Sidebar Colum styles",
	"desc" => "Select the style for Footer Sidebar",
	"id" => SHORTNAME."_footer_third_colum_style",
	"type" => "radio",
	"options" => array(
		'1' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/1column.png"/></div>',
		'2' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/2columns.png"/></div>',
...
array( "name" => "• Columna Uno",
	"desc" => "Ingresar el texto a mostrar en Columna Uno",
	"id" => SHORTNAME."_footer_third_row_column_one",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Dos",
	"desc" => "Ingresar el texto a mostrar en Columna Dos",
	"id" => SHORTNAME."_footer_third_row_column_two",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Tres",
	"desc" => "Ingresar el texto a mostrar en Columna Tres",
	"id" => SHORTNAME."_footer_third_row_column_three",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Cuatro",
	"desc" => "Ingresar el texto a mostrar en Columna Cuatro",
	"id" => SHORTNAME."_footer_third_row_column_four",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Display Short Code",
	"desc" => "Check this to display Short Code",
	"id" => SHORTNAME."_footer_third_show_short_code",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Incluir Short Code en columna (para formularios y otros)",
	"desc" => "Selecciones la columna donde será incluido el Short Code (para formularios y otros)",
	"id" => SHORTNAME."_footer_third_into_colum_code",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Short Code (para formularios y otros)",
	"desc" => "Ingresar el código",
	"id" => SHORTNAME."_footer_third_short_code",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "-Display social icons",
	"desc" => "Check this to display social icons in footer",
	"id" => SHORTNAME."_footer_third_social_display",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "-Incluir Iconos de redes sociales",
	"desc" => "Selecciones la columna donde serán incluidos los iconos",
	"id" => SHORTNAME."_footer_third_into_colum_social",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "-Open Footer Social Icons link in new window",
	"desc" => "Check this to open footer social icons link in new window",
	"id" => SHORTNAME."_footer_third_social_link_blank",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar linea horizontal separadora",
	"desc" => "Para separar las secciones del footer con una linea divisora",
	"id" => SHORTNAME."_footer_third_separating_horizontal_line",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar idiomas",
	"desc" => "Seleccionar para mostrar idiomas",
	"id" => SHORTNAME."_footer_third_show_languages",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar idiomas en columna",
	"desc" => "Selecciones la columna donde serán incluidos los idiomas",
	"id" => SHORTNAME."_footer_third_column_show_languages",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Mostrar logo",
	"desc" => "Seleccionar para mostrar el logo",
	"id" => SHORTNAME."_footer_third_show_logo",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar logo en columna",
	"desc" => "Selecciones la columna donde serán incluidos el logo",
	"id" => SHORTNAME."_footer_third_column_show_logo",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Background Color",
	"desc" => "Select background color for this area",
	"id" => SHORTNAME."_footer_third_bg_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#000000"
),
...
array( "name" => "Header Font Color",
	"desc" => "Select color for the widget header font",
	"id" => SHORTNAME."_footer_third_header_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),
...
array( "name" => "Font Color",
	"desc" => "Select color for the font",
	"id" => SHORTNAME."_footer_third_font_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#999999"
),
...
array( "name" => "Link Color",
	"desc" => "Select color for the link",
	"id" => SHORTNAME."_footer_third_link_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#aaaaaa"
),
...
array( "name" => "Hover Link Color",
	"desc" => "Select color for the hover font",
	"id" => SHORTNAME."_footer_third_hover_link_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),
...
/* Fourth Row { */
array( "name" => "<h2>• Fourth ROW, Columns Settings</h2>",
	"type" => "header",
),
array( "name" => "Footer Sidebar Colum styles",
	"desc" => "Select the style for Footer Sidebar",
	"id" => SHORTNAME."_footer_fourth_colum_style",
	"type" => "radio",
	"options" => array(
		'1' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/1column.png"/></div>',
		'2' => '<div style="float:left;width:70px;height:60px"><img src="'.get_template_directory_uri().'/functions/images/2columns.png"/></div>',
...
array( "name" => "• Columna Uno",
	"desc" => "Ingresar el texto a mostrar en Columna Uno",
	"id" => SHORTNAME."_footer_fourth_row_column_one",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Dos",
	"desc" => "Ingresar el texto a mostrar en Columna Dos",
	"id" => SHORTNAME."_footer_fourth_row_column_two",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Tres",
	"desc" => "Ingresar el texto a mostrar en Columna Tres",
	"id" => SHORTNAME."_footer_fourth_row_column_three",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Columna Cuatro",
	"desc" => "Ingresar el texto a mostrar en Columna Cuatro",
	"id" => SHORTNAME."_footer_fourth_row_column_four",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Display Short Code",
	"desc" => "Check this to display Short Code",
	"id" => SHORTNAME."_footer_fourth_show_short_code",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Incluir Short Code en columna (para formularios y otros)",
	"desc" => "Selecciones la columna donde será incluido el Short Code (para formularios y otros)",
	"id" => SHORTNAME."_footer_fourth_into_colum_code",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Short Code (para formularios y otros)",
	"desc" => "Ingresar el código",
	"id" => SHORTNAME."_footer_fourth_short_code",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Display social icons",
	"desc" => "Check this to display social icons in footer",
	"id" => SHORTNAME."_footer_fourth_social_display",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Incluir Iconos de redes sociales",
	"desc" => "Selecciones la columna donde serán incluidos los iconos",
	"id" => SHORTNAME."_footer_fourth_into_colum_social",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Open Footer Social Icons link in new window",
	"desc" => "Check this to open footer social icons link in new window",
	"id" => SHORTNAME."_footer_fourth_social_link_blank",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar linea horizontal separadora",
	"desc" => "Para separar las secciones del footer con una linea divisora",
	"id" => SHORTNAME."_footer_fourth_separating_horizontal_line",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar idiomas",
	"desc" => "Seleccionar para mostrar idiomas",
	"id" => SHORTNAME."_footer_fourth_show_languages",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar idiomas en columna",
	"desc" => "Selecciones la columna donde serán incluidos los idiomas",
	"id" => SHORTNAME."_footer_fourth_column_show_languages",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Mostrar logo",
	"desc" => "Seleccionar para mostrar el logo",
	"id" => SHORTNAME."_footer_fourth_show_logo",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Mostrar logo en columna",
	"desc" => "Selecciones la columna donde serán incluidos el logo",
	"id" => SHORTNAME."_footer_fourth_column_show_logo",
	"type" => "radio",
	"options" => array(
		'1' => 'Coluna uno',
		'2' => 'Coluna Dos',
...
array( "name" => "Background Color",
	"desc" => "Select background color for this area",
	"id" => SHORTNAME."_footer_fourth_bg_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#000000"
),
...
array( "name" => "Header Font Color",
	"desc" => "Select color for the widget header font",
	"id" => SHORTNAME."_footer_fourth_header_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),
...
array( "name" => "Font Color",
	"desc" => "Select color for the font",
	"id" => SHORTNAME."_footer_fourth_font_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#999999"
),
...
array( "name" => "Link Color",
	"desc" => "Select color for the link",
	"id" => SHORTNAME."_footer_fourth_link_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#aaaaaa"
),
...
array( "name" => "Hover Link Color",
	"desc" => "Select color for the hover font",
	"id" => SHORTNAME."_footer_fourth_hover_link_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),
...
array( "name" => "<h2>Footer Content Colors Settings</h2>",
	"type" => "header",
),
...
array( "name" => "<h2>Copyright Bar Colors Settings</h2>",
	"type" => "header",
),
array( "name" => "Copyright Bar Background Color",
...
array( "name" => "<h2>Habitación Page Settings</h2>Display search form on Habitación pages",
	"desc" => "Check to display search form on Habitación pages",
	"id" => SHORTNAME."_habitacion_search",
	"type" => "iphone_checkboxes",
	"std" => 1
),

array( "name" => "Habitación page show at most",
	"desc" => "Enter number of Habitación items you want to display per page",
	"id" => SHORTNAME."_habitacion_items_page",
	"type" => "jslider",
	"size" => "40px",
	"std" => "9",
	"from" => 1,
...
array( "name" => "Make Habitación Title font uppercase",
	"desc" => "Check to make Habitación title font uppercase",
	"id" => SHORTNAME."_habitacion_title_upper",
	"type" => "iphone_checkboxes",
	"std" => 1
),

array( "name" => "Habitación Sale Badge Background Color",
	"desc" => "Select background color for sale Habitación badge",
	"id" => SHORTNAME."_habitacion_sale_bg",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#b63327"
),

array( "name" => "Habitación Sale Badge Font Color",
	"desc" => "Select font color for sale Habitación badge",
	"id" => SHORTNAME."_habitacion_sale_font",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#ffffff"
),

array( "name" => "Habitación Item Background Color In hover State",
	"desc" => "Select background color for Habitación item in hover state",
	"id" => SHORTNAME."_habitacion_hover_bg",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#b63327"
),

array( "name" => "Habitación List Meta Font Color",
	"desc" => "Select color for the Habitación meta",
	"id" => SHORTNAME."_habitacion_meta_font_color",
	"type" => "colorpicker",
	"size" => "60px",
	"std" => "#b63327"
),

array( "name" => "<h2>Single Habitación Settings</h2>Display next and previous Habitación on single page",
	"desc" => "Check this option to display next and previous Habitaciones in single Habitación page",
	"id" => SHORTNAME."_habitacion_next_prev",
	"type" => "iphone_checkboxes",
	"std" => 1
),

array( "name" => "Hide habitación attribute bar",
	"desc" => "Check this option to hide habitación attribute bar (date, duration, price and avaibility) in single habitación page",
	"id" => SHORTNAME."_habitacion_attribute",
	"type" => "iphone_checkboxes",
	"std" => 1
),

array( "name" => "Enable comment",
	"desc" => "Check this option to enable comment function in single habitación page",
	"id" => SHORTNAME."_habitacion_comment",
	"type" => "iphone_checkboxes",
	"std" => 1
),

array( "name" => "<h2>Habitación Booking Settings</h2>Send a copy of booking email to customer",
	"desc" => "Check this option to send a booking email to customer when they booked habitación",
	"id" => SHORTNAME."_habitacion_book_email_customer",
	"type" => "iphone_checkboxes",
	"std" => 1
),

array( "type" => "close"),
//End second tab "Habitación"
/* } THISNEW */
...
array( "name" => "Icono personalizado para el mapa",
	"desc" => "Please upload or insert full image URL to use for map",
	"id" => SHORTNAME."_map_icon",
	"type" => "image",
	"std" => "",
),
array( "name" => "Total items",
	"desc" => "Please enter the maximum number of items to display",
	"id" => SHORTNAME."_map_max_items",
	"type" => "text",
	"std" => "50",
),
...
array( "name" => "<h2>Twitter API Settings</h2>Twitter Consumer Key <a href=\"https://apps.twitter.com/\">See instructions</a>",
...
array( "name" => "<h2>404 Settings</h2>Titulo",
	"desc" => "Ingrese el titulo a mostrar",
	"id" => SHORTNAME."_404_title",
	"type" => "text",
	"std" => ""
),
array( "name" => "Detail",
	"desc" => "Ingrese el detalle a mostrar",
	"id" => SHORTNAME."_404_detail",
	"type" => "textarea",
	"std" => ""
),
array( "name" => "Volver a la home",
	"desc" => "Mostrar boton de volver a la home",
	"id" => SHORTNAME."_404_display_back_home",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Volver atrás",
	"desc" => "Mostrar boton de volver atras",
	"id" => SHORTNAME."_404_display_history_back",
	"type" => "iphone_checkboxes",
	"std" => 1
),
array( "name" => "Imagen de fondo",
	"desc" => "Cargue la imagen que será usada de fondo",
	"id" => SHORTNAME."_404_background_image",
	"type" => "image",
	"std" => "",
),
array( "type" => "close"),
