<?php
/**
 * Template Name: Page Landing Page 2
...
$page_form_short_code = !empty($page_form) ? $page_form : 'NADA';
    ...
    <div class="inner">
    	...
    	<div class="inner_wrapper">
            ...
            <div class="two_cols" style="margin-bottom: 35px;">
                <div class="cols one">
                    <div class="detail"><?php echo $post_content; ?></div>
                ...
                <div class="cols two">
                    ...
                    <div class="detail"><?php echo do_shortcode($page_form_short_code); ?></div>
                </div>
            </div>
            <?php
			};
